...
class ProxyServer:
    ...
    async def handle_redirect(self, request):
        ...
        # Update click count
        db(db.urls.id == url_record.id).update(
            click_count=url_record.click_count + 1
        )
    ...
    async def start(self):
        ...
        https_site = web.TCPSite(runner, '0.0.0.0', PROXY_HTTPS_PORT, ssl_context=ssl_context)
