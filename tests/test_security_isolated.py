...
class TestSecurityIsolated(unittest.TestCase):
    ...
    def test_check_sql_injection(self):
        ...
        # Suspicious input
        self.assertFalse(
            SecurityIsolated.check_sql_injection("'; DROP TABLE users; --")
        )
        self.assertFalse(
            SecurityIsolated.check_sql_injection("UNION SELECT * FROM users")
        )
        ...
        self.assertFalse(
            SecurityIsolated.check_sql_injection("SELECT password FROM users")
        )
