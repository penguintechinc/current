...
class TestApplicationStartup(unittest.TestCase):
    ...
    def test_main_py_structure(self):
        ...
        main_py_path = os.path.join(
            os.path.dirname(__file__), "../shorturl-app/main.py"
        )
    ...
    def test_settings_structure(self):
        ...
        settings_path = os.path.join(
            os.path.dirname(__file__), "../shorturl-app/settings.py"
        )
    ...
    def test_docker_compose_structure(self):
        ...
        for element in required_elements:
            self.assertIn(
                element, content, f"Missing docker-compose element: {element}"
            )

    def test_dockerfile_structure(self):
        """Test that Dockerfile has proper structure"""
        dockerfile_path = os.path.join(
            os.path.dirname(__file__), "../shorturl-app/Dockerfile"
        )
    ...
    def test_entrypoint_structure(self):
        ...
        entrypoint_path = os.path.join(
            os.path.dirname(__file__), "../shorturl-app/entrypoint.sh"
        )
    ...
    def test_requirements_files(self):
        ...
        req_path = os.path.join(
            os.path.dirname(__file__), "../shorturl-app/requirements.txt"
        )
        dev_req_path = os.path.join(
            os.path.dirname(__file__), "../shorturl-app/requirements-dev.txt"
        )
        ...
        essential_packages = ["py4web", "pydal", "aiohttp", "qrcode", "cryptography"]
